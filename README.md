...
```
    ...
    cd /opt/exporter
    sudo curl https://raw.githubusercontent.com/safaksoylu/homeip-exporter/main/credentials.json?token= --output credentials.json
    sudo curl https://raw.githubusercontent.com/safaksoylu/homeip-exporter/main/token.json?token= --output token.json
